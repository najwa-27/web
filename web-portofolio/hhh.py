...
def topping() :
    ...
    if nomor == 1:
        ...
        totaltopping = porsi * 3000
        print (porsi,'Orea - Rp. ',totaltopping)
        topping=("Oreo")
    elif nomor == 7:
        totaltopping = porsi * 3000
        ...
        totaltopping = porsi * 0
        print (porsi, 'Tanpa topping - Rp. ',totaltopping)
